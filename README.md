...
| `sensor.<you_car_alias>_charging_status`       | Charging status (Not connected, Plugged in).       |
| `sensor.<you_car_alias>_remaining_charge_time` | Remaining time until charging is complete.         |
